...
const SocialForm = () => {
  ...
  const handleSubmit = (e) => { e.preventDefault(); alert(`Social: ${JSON.stringify(datos)}`); };
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-lg border border-blue-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button type="submit" className="w-full bg-blue-600 text-white font-bold py-2 rounded mt-4 hover:bg-blue-700">REGISTRAR</button>
      </form>
    </div>
  );
};
