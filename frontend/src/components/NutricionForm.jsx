...
const NutricionForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(`Nutrición: ${JSON.stringify(datos)}`);
  };
  ...
  return (
    // PASO 1: h-full flex flex-col (Estira la tarjeta)
    <div className="bg-white p-6 rounded-2xl shadow-lg border border-green-100 h-full flex flex-col">
      ...
      {/* PASO 2: flex flex-col flex-grow (Ocupa todo el hueco disponible) */}
      <form onSubmit={handleSubmit} className="space-y-4 flex flex-col flex-grow">
        ...
        {/* PASO 3: mt-auto (Empuja el botón al final SIN perder el color verde) */}
